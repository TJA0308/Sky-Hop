...
export const LEVEL_META = [
  ...
  { name: 'Double Jump', zone: 2, hint: 'Grab the sparkle; release jump, then press again in midair!' },
  { name: 'Wind Crossing', zone: 2, hint: 'Ride the drifters — time your jumps!' },
  { name: 'Wisp Hollow', zone: 3, hint: 'Grab the sparkle first! Double-jump across gaps; stomp Wisps.' },
